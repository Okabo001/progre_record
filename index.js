...
const prevtE1 = document.getElementById(".prev");
const progresE1 = document.querySelector(".progress-bar-front")
...
prevE1.addEventListener("click", () => {
    ...
    function updateStepProgress(){
        ...
        progresE1.getElementsByClassName.width = ((checkedNumber.length - 1) / (stepsE1.length - 1)) * 100 + "%";
